  ...
  return (
    <Box p={2}>
      ...
      <Box display="flex" gap={2} mb={2} flexWrap="wrap">
        <TextField aria-label="input field" label={t("search_by_civil_id") || "بحث بالرقم المدني للرخصة"} size="small" value={searchCivilId} onChange={e => setSearchCivilId(e.target.value)} />
      ...
      <Dialog open={addOpen} onClose={() => setAddOpen(false)}>
        ...
        <DialogContent>
          <TextField aria-label="input field" margin="dense" label={t('licenseType')} name="licenseType" value={newLicense.licenseType} onChange={handleAddChange} fullWidth required error={!newLicense.licenseType} helperText={!newLicense.licenseType ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('expiryDate')} name="expiryDate" type="date" value={newLicense.expiryDate} onChange={handleAddChange} fullWidth required error={!newLicense.expiryDate} helperText={!newLicense.expiryDate ? t('required') : ''} InputLabelProps={{ shrink: true }} />
          <TextField aria-label="input field" margin="dense" label={t('name')} name="name" value={newLicense.name} onChange={handleAddChange} fullWidth required error={!newLicense.name} helperText={!newLicense.name ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('civil_id')} name="civil_id" value={newLicense.civil_id} onChange={handleAddChange} fullWidth required error={!newLicense.civil_id} helperText={!newLicense.civil_id ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('issuing_authority')} name="issuing_authority" value={newLicense.issuing_authority} onChange={handleAddChange} fullWidth required error={!newLicense.issuing_authority} helperText={!newLicense.issuing_authority ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('status')} name="status" value={newLicense.status} onChange={handleAddChange} fullWidth required error={!newLicense.status} helperText={!newLicense.status ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('issue_date')} name="issue_date" type="date" value={newLicense.issue_date} onChange={handleAddChange} fullWidth required error={!newLicense.issue_date} helperText={!newLicense.issue_date ? t('required') : ''} InputLabelProps={{ shrink: true }} />
          <TextField aria-label="input field" margin="dense" label={t('labor_count')} name="labor_count" type="number" value={newLicense.labor_count} onChange={handleAddChange} fullWidth required error={!newLicense.labor_count} helperText={!newLicense.labor_count ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('license_number')} name="license_number" value={newLicense.license_number} onChange={handleAddChange} fullWidth required error={!newLicense.license_number} helperText={!newLicense.license_number ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('address')} name="address" value={newLicense.address} onChange={handleAddChange} fullWidth required error={!newLicense.address} helperText={!newLicense.address ? t('required') : ''} />
      ...
      <Dialog open={editOpen} onClose={() => setEditOpen(false)}>
        ...
        <DialogContent>
          <TextField aria-label="input field" margin="dense" label={t('licenseType')} name="licenseType" value={editLicense?.licenseType || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.licenseType} helperText={editLicense && !editLicense.licenseType ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('expiryDate')} name="expiryDate" type="date" value={editLicense?.expiryDate || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.expiryDate} helperText={editLicense && !editLicense.expiryDate ? t('required') : ''} InputLabelProps={{ shrink: true }} />
          <TextField aria-label="input field" margin="dense" label={t('name')} name="name" value={editLicense?.name || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.name} helperText={editLicense && !editLicense.name ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('civil_id')} name="civil_id" value={editLicense?.civil_id || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.civil_id} helperText={editLicense && !editLicense.civil_id ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('issuing_authority')} name="issuing_authority" value={editLicense?.issuing_authority || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.issuing_authority} helperText={editLicense && !editLicense.issuing_authority ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('status')} name="status" value={editLicense?.status || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.status} helperText={editLicense && !editLicense.status ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('issue_date')} name="issue_date" type="date" value={editLicense?.issue_date || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.issue_date} helperText={editLicense && !editLicense.issue_date ? t('required') : ''} InputLabelProps={{ shrink: true }} />
          <TextField aria-label="input field" margin="dense" label={t('labor_count')} name="labor_count" type="number" value={editLicense?.labor_count || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.labor_count} helperText={editLicense && !editLicense.labor_count ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('license_number')} name="license_number" value={editLicense?.license_number || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.license_number} helperText={editLicense && !editLicense.license_number ? t('required') : ''} />
          <TextField aria-label="input field" margin="dense" label={t('address')} name="address" value={editLicense?.address || ''} onChange={handleEditChange} fullWidth required error={editLicense && !editLicense.address} helperText={editLicense && !editLicense.address ? t('required') : ''} />
          <FormControl fullWidth margin="dense">
